...
public class CommonProxy {
	public void preInit(FMLPreInitializationEvent event) {
		ModItems.init();
		RegistryUtils.registerModEntity(EntityEraserBomb.class, "eraser_bomb", References.ENTITY_ID_ERASER_BOMB, EraserBomb.INSTANCE, 32, 5, true);
	}
	...
	public void init(FMLInitializationEvent event) {
		for (int i = 0; i < 18; i ++) {
			...
			else if (Utils.isBetweenXAndY(i, 1, 5) || Utils.isBetweenXAndY(i, 7, 11))
			...
			else if (Utils.isBetweenXAndY(i, 12, 17))
